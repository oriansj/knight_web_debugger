...
https://git.sr.ht/~oriansj/knight_web_debugger

with the following mirrors:
https://github.com/oriansj/knight_web_debugger.git

a simple web interface for debugging programs running on knight hardware.
